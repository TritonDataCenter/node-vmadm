...
class BackendProp {
    /**
     * @param name {string}- The systemd property name
     * @param [opts] {Object}
     * @param [opts.default] {} - The type-specific default value.
     * @param [opts.allowed] {array} - Array of allowed values.
     * @param [opts.read_only] {boolean} - The property can only be read from
     * systemd.  For instance, the state cannot be set to 'running'.
     * @param [opt.set_once] {boolean}  - The property can be set once and not
     * changed.
     * @param [opt.nspawn_section] {string} - The section of a systemd.nspawn
     ...
     * @param [opt.service_section] {string} - The section of a systemd.service
     ...
     * @param [opts] {object}
     * @param [opts.only_dirty] {boolean} - Return a value only if the property
...
class MachineBackend extends EventEmitter {
     ...
     * @param [opts] {object}
     * @param [opts.log] {object} - A logger, probably from bunyan.  If not,
     * provided, console will be used.
     * @param [opts.systemd_dir] {string} - The top of the systemd hierarchy.
     * Default is '/run/systemd'.
     * @param [opts.run_dir] {string} - The directory that will contain other
